            ...
            <div class="middle detail">
                <div class="title-landing full">
                    <div class="title">
                        ...
                        <small>{{ trans('frontend.story.news.news') }}</small>
                        <h3>{{ trans('frontend.story.blog_details.new_item_arrival') }} STEERING CONE MX-SERIES</h3>
                ...
                <div class="text-content">
                    ...
                    <p>&nbsp;</p>
                    <p><strong>{{ trans('frontend.story.blog_details.new_item') }} </strong></p>
                    ...
                    <p>&nbsp;</p>
                    <p><strong>{{ trans('frontend.story.blog_details.feature') }}</strong></p>
                    <p>&nbsp;</p>
                    ...
                    <p>&nbsp;</p>
                    <p>To find out more or order, please chat Faito Careline on <strong>{{ trans('frontend.story.blog_details.live_chat') }}</strong>.</p>
