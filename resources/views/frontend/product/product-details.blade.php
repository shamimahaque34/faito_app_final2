        ...
        <div class="wrapper">
            <div class="breadcrumb">
                <ul>
                    ...
                    <li><a href="{{ route('frontend.product') }}">Faito Products</a> </li>
                    <li><a href="{{ route('frontend.sub-cat') }}">BEARING SYSTEM</a></li>
                    <li><a href="{{ route('frontend.sub-sub-cat') }}">Faito Lite-Tech Bearing</a></li>
                    <li>FAITO LITE-TECH BEARING SET</li>
                </ul>
            </div>
            <div class="detail-product">
                <div class="left-box">
                    <div class="slider-big">
                        <div class="list">
                            <figure><img src="{{ asset('/') }}frontend/assets/contents/OrbHheveLM.png" alt=""></figure>
                        </div>
                        <div class="list">
                            <figure><img src="{{ asset('/') }}frontend/assets/contents/8fboMRNdKg.png" alt=""></figure>
                        </div>
                    </div>
                ...
                <div class="right-box">
                    <div class="title-product">
                        ...
                        <small>Faito Lite-Tech Bearing</small>
                        <h1>FAITO LITE-TECH BEARING SET</h1>
                        <p><strong><span lang="EN-US" style="font-size: 14pt; line-height: 107%; font-family: arial, helvetica, sans-serif;"><em><span lang="EN-US" style="line-height: 107%; font-family: Calibri, sans-serif;">INCREASE YOUR MOTORCYCLE PERFORMANCE WITH FAITO LITE-TECH BEARING</span></em></span></strong></p>
                        <p style="text-align: justify;">Bearings with medium speed bearings have the ability to support rotations of up to 10,000 RPM which are suitable for use in daily use motors. Provided with a special package in the form of a complete package consisting of a pair of crankshaft bearings and bearings for the gear ratio gear box. Provides better engine performance from initial start to high speed.</p>
                    ...
                    <div class="marketplace">
                        ...
                        <a href="https://www.tokopedia.com/faitoofficial/product?keyword=bearing%20set%20lite-tech" rel="nofollow"><img src="{{ asset('/') }}frontend/assets/images/content/ecom-1.png" alt=""></a>
            ...
            <div class="wrap-tab">
                ...
                <div class="wrap-overflow">
                    <div class="box-tabing information">
                        <div class="head-tab">
                            <ul>
                                <li><a href="#desc">Description</a></li>              <li><a href="#feat">Features</a></li>                          </ul>
                        </div>
                        <div class="content-tab text-content" id="desc">
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">Faito Lite-Tech bearings are packaged individually, so they can adapt to the needs of replacing spare parts on your motorbike.</span></span> <span class="jCAhz ChMk0b"><span class="ryNqvb">Faito Lite-Tech bearings with medium speed bearings have the ability to support rotations of up to 10,000 RPM which are suitable for daily use on motorbikes.</span></span> <span class="jCAhz ChMk0b"><span class="ryNqvb">Faito Lite-Tech bearings with teflon and composite materials retain less weight and reduce friction.</span></span> <span class="jCAhz ChMk0b"><span class="ryNqvb">Faito Lite-Tech bearings are very suitable for use on everyday motorbikes that want maximum performance, as well as for racing competitions.</span></span></span></p>
                            <p>&nbsp;</p>
                        </div>
                        <div class="content-tab text-content" id="feat">
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">&bull; Faito Lite-Tech bearings are C3 rated and high performance axle bearings</span></span> </span></p>
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">&bull; Bearings Faito Lite-Tech on the inner ring and outer ring using carbon steel material</span></span> </span></p>
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">&bull; Faito Lite-Tech bearing retainer cage uses Teflon material so that it weighs less</span></span> </span></p>
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">&bull; Faito Lite-Tech bearings have superior hardness and strength for high performance</span></span> </span></p>
                            <p><span class="HwtZe" lang="en"><span class="jCAhz ChMk0b"><span class="ryNqvb">&bull; Faito Lite-Tech bearings have better glide</span></span></span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="related-product">
                ...
                <div class="listing-wrap product no-margin">
                    <a href="../s270-bearing/bearing-set-s720.html" class="list">
                        <figure>
                            <img src="{{ asset('/') }}frontend/assets/contents/enGez9MhKu.png" alt="">
                        </figure>
                        <span class="name-sparepart">Faito S720 Bearing</span>
                        <h5>FAITO S720 BEARING SET</h5>
                    </a>
                    <a href="lite-tech-bearing-laher-satuan-2.html" class="list">
                        <figure>
                            <img src="{{ asset('/') }}frontend/assets/contents/TjqicPh1jK.png" alt="">
                        </figure>
                        <span class="name-sparepart">Faito Lite-Tech Bearing</span>
                        <h5>FAITO LITE-TECH BEARING (SINGLE PACK)</h5>
                    </a>
                    <a href="lite-tech-bearing-camshaft.html" class="list">
                        <figure>
                            <img src="{{ asset('/') }}frontend/assets/contents/HFOOgoZv8a.png" alt="">
                        </figure>
                        <span class="name-sparepart">Faito Lite-Tech Bearing</span>
                        <h5>FAITO CAMSHAFT BEARING</h5>
                    </a>
                    <a href="crankshaft-lite-tech-bearing.html" class="list">
                        <figure>
                            <img src="{{ asset('/') }}frontend/assets/contents/XZwCM69iov.png" alt="">
                        </figure>
                        <span class="name-sparepart">Faito Lite-Tech Bearing</span>
                        <h5>FAITO CRANKSHAFT BEARING</h5>
                    </a>
